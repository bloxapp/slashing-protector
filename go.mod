...
// From https://github.com/bloxapp/key-vault/blob/master/go.mod
// "go.mode throwing error when prysm point dirctly to v2.X so replace to v2.0.1 here"
replace github.com/prysmaticlabs/prysm => github.com/moshe-blox/prysm v1.4.2-0.20221221204425-f689e925fb63
